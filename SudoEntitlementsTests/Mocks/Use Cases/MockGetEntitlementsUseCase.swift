...
class MockGetEntitlementsUseCase: GetEntitlementsUseCase {
    ...
    var executeResult: ExecuteResult = .failure(AnyError("Please add base result to `MockGetEntitlementsUseCase.execute`"))
